...
class Application_schema
{
	public function index($name)
	{
		...
		instantiate_application_schema_handler(lib('db'), lib('database_schema'));
		load_model('ApplicationSchemaModel', 'application_schema_model', lib('database_schema_handler'));
